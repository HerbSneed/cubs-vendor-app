...
import { updateBasicInfo } from "./client/src/utils/redux/actions/actions";
...
const BasicInfo = ({ basicInfo, updateBasicInfo }) => {
  ...
  return (
    <div id="locale" className="flex items-center justify-center ">
      <form
        id="basicInfoForm"
        method="POST"
        onSubmit={handleBasicClick}
        className="bg-cubblue border-2 border-cubred bg-opacity-80 shadow-lg rounded-xl mx-auto flex flex-col my-[10%] sm:my-[6%] md:my-[15%] lg:my-0 gap-2 p-3 w-9/12 sm:w-8/12 md:w-5/12 lg:w-4/12 2xl:w-3/12"
      >
        <div className="flex flex-wrap gap-x-2">
          ...
          <div className="flex flex-col w-2/3 flex-auto sm:w-[30%]">
          ...
          <div className="flex flex-col w-1/4 sm:w-[10%] md:w-[30%] flex-auto">
          ...
          <div className="flex flex-col w-full sm:w-[70%] flex">
